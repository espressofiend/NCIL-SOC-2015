...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.00), Mon Jun 22 22:56:10 2015
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if text_2.status == STARTED and t >= (0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        if text_3.status == STARTED and t >= (1 + (1-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        if t >= 1 and key_resp_2.status == NOT_STARTED:
            ...
            event.clearEvents(eventType='keyboard')
        if key_resp_2.status == STARTED and t >= (1 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
